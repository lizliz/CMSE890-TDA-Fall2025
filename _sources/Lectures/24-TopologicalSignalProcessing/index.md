...
This lecture discusses the basics of using TDA for signal processing, which we call Topological Signal Processing (TSP). 

- **Reading:**
  - TBD

- **Slides:**
  - [Lecture 24 slides pdf](./CompTop-Lec24-TopolgicalSignalProcessing.pdf)
